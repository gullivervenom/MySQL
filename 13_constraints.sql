...
values
(1, 'user01', 'pass01', '박재민', '남', '01012345678', 'gullivervenom@gmail.com'),
(2, 'user02', 'pass02', '박재순', '여', '01023456789', 'thaigullivervenom@gmail.com');

select * from user_notnull;

insert into user_notnull
values
(1, 'user01', null, '박재민', '남', '01012345678', 'gullivervenom@gmail.com'),
(2, 'user02', 'pass02', '박재순', '여', '01023456789', 'thaigullivervenom@gmail.com');

truncate table user_notnull;

-- unique 제약 조건
-- 중복된 값을 허용하지 않는 제약 조건
drop table if exists user_unique;
create table if not exists user_unique(
	user_no int not null unique,       -- not 허용 안하면서, 유일한 값
    user_id varchar(30) not null,
    user_pwd varchar(40) not null,
    user_name varchar(30) not null,
    gender varchar(3),
    phone varchar(30) not null,
    email varchar(50),
    unique(phone)  -- 이런 식으로도 제약조건 설정 가능
) engine=innodb;
...
values
(1, 'user01', 'pass01', '박재민', '남', '01012345678', 'gullivervenom@gmail.com'),
(2, 'user02', 'pass02', '박재순', '여', '01012345678', 'gullivervenom@gmail.com');
...
create table if not exists user_pk(
    ...
    phone varchar(30) not null,
    email varchar(50),
    primary key (user_no)  -- 이런 식으로도 제약조건 설정 가능
) engine=innodb;
...
values
(1, 'user01', 'pass01', '박재민', '남', '01012345678', 'gullivervenom@gmail.com', 10),
(2, 'user02', 'pass02', '박재순', '여', '01012345678', 'gullivervenom@gmail.com', 20);
select * from user_fk1;

insert into user_fk1
values
-- error 1062 : 참조하고 있는 테이블(부모테이블)에는 존재하지 않는 값을 집어넣을 때
-- 발생하는 에러 > foreign key 제약조건 위반
(2, 'user02', 'pass02', '박재순', '여', '01012345678', 'gullivervenom@gmail.com', 25);
